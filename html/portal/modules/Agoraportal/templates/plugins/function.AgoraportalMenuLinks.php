...
function smarty_function_AgoraportalMenuLinks($params, &$smarty) {
    ...
    if ($isAdmin) {
        ...
        $menu .= ' <li role="presentation"><a href="' . DataUtil::formatForDisplayHTML(ModUtil::url('Agoraportal', 'admin', 'advices')) . '"><span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span> ' . __('Avisos') . '</a> ';
