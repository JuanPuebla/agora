...
<form id="editService" class="form-horizontal" action="{modurl modname='Agoraportal' type='admin' func='updateService'}" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select class="form-control" ="type" name="typeId">
    ...
    <div class="form-group">
        <label class="col-sm-4 control-label" for="educat">{gt text="Centre eduCAT 1x1"}:</label>
        <div class="col-sm-8">
