...
<td>
    <input class="form-control" type="text" name="version_{$service.serviceId}" size="{$service.version|count_characters}" value="{$service.version}" />
</td>
<td>
...
<td>
    <a class="btn btn-success" href="#servicesList" onclick="updateService({$service.serviceId});" title="Desa">
